      ...
      <div id="page-wrapper">
        ...
        <!-- Header -->
          <header id="header" class="alt">
            <h1><a href="index.html">Website RPL</a></h1>
            <nav id="nav">
              <ul>
                <li class="special">
        ...
        <!-- Banner -->
          <section id="banner">
            <div class="inner">
              ...
              <p>di Website <br>Rekayasa Perangkat Lunak <br>SMK Negeri 5 Malang</p>
              <ul class="actions">
        ...
        <!-- One -->
          <section id="one" class="wrapper style1 special">
            <div class="inner">
              <header class="major">
                <h2> Website <br />
                Rekayasa Perangkat Lunak</h2>
                <p>Dengan WEBSITE Ini <br />
                kami memberikan fasilitas untuk memudahkan aktifitas yang berhubungan dengan jurusan</p>
              </header>
            </div>
          </section>
          ...
          <section id="two" class="wrapper alt style2">
            <section class="spotlight">
              <div class="image"><img src="images/pic01.jpg" alt="" /></div><div class="content">
                ...
                <div class="btn-lanjut">
                  <a href="pages/login/siswa.php" class="button fit">Learn More</a>
                </div>
              </div>
            </section>
            <section class="spotlight">
            ...
            <section class="spotlight">
              <div class="image"><img src="images/pic02.jpg" alt="" /></div><div class="content">
                ...
                <div class="btn-lanjut">
                  <a href="pages/login/admin.php" class="button fit">Learn More</a>
                </div>
              </div>
            </section>
          </section>
        ...
        <!-- Three -->
          <section id="three" class="wrapper style3 special">
            <div class="inner">
              <header class="major">
                <h2>Guru Program Keahlian Rekayasa Perangkat Lunak</h2>
                <!-- <p>Aliquam ut ex ut augue consectetur interdum. Donec amet imperdiet eleifend<br /> -->
                <!-- fringilla tincidunt. Nullam dui leo Aenean mi ligula, rhoncus ullamcorper.</p> -->
              </header>
              <ul class="features">
                <li class="icon fa-paper-plane-o">
                  <h3>Alwan Ali Latief MT</h3>
                  <p>Kepala Jurusan + RPL</p>
                </li>
                <li class="icon fa-laptop">
                  <h3>Fandik Ariyanto S.ST</h3>
                  <p>Kepala Bidang + RPL</p>
                </li>
                ...
                <li class="icon fa-headphones">
                  <h3>Hendra Saputra S.ST</h3>
                  <p>Guru + RPL</p>
                </li>
                <li class="icon fa-heart-o">
                  <h3>Sulastri Suhana S.Pd</h3>
                  <p>Guru + RPL</p>
                </li>
