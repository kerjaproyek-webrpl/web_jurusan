<?php 
	...
	$a = mysql_query("SELECT siswa.nama, pendidikan.nama_pendidikan
					FROM siswa INNER JOIN pendidikan
	 				ON siswa.id_pendidikan = pendidikan.id_pendidikan;");
					...
					<table id="example" class="table table-bordered table-hovered tbl-dt" cellspacing="0" width="100%">
						...
						<tbody>
							<tr>
								...
								<td><?php echo $b['nama_pendidikan']; ?></td>
								<td>
