<?php 
	...
	$n = $sis['COUNT(*)'];
	$a = $_SESSION['id'];
	$q = "SELECT * FROM admin WHERE id='$a'";
	$e = mysql_query($q);
			...
			<div id="header" class="header navbar navbar-default navbar-fixed-top">
				<div class="container-fluid">
					<div class="navbar-header">
						<a href="#" class="navbar-brand">Admin | Web Jurusan</a>
				...
				<div data-scrollbar="true" data-height="100%">
					<ul class="nav">
						<li class="nav-profile">
							<div class="image">
								<a href="javascript:;"><img src="../assets/images/user-6.jpg" alt="" /></a>
							</div>
							<div class="info">
								<?php echo $w['nama']; ?>
					...
					<!-- end sidebar user -->
					<?php require_once "list_item-admin.php"; ?>
				</div>
			</div>
